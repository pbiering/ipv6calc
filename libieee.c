 ...
 * Project    : ipv6calc
 * File       : libieee.c
 * Version    : $Id: libieee.c,v 1.2 2002/03/16 19:40:29 peter Exp $
...
int libieee_get_short_vendor_string(char *resultstring, const unsigned short o1,  const unsigned short o2,  const unsigned short o3) {
	int retval = 1;
	int i;
	unsigned int idval;
