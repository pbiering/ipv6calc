...
my $program_version = "0.40pre8";       # automatic generated line, don't remove this token: @@VERSION@@
...
if ($outputformat eq "html" || $outputformat eq "htmlfull") {
	print "<font size=-2>Generated by " . $program_name . " " . $program_version . ", " . $program_copyright . "</font><br>\n";
	...
	print "Generated by " . $program_name . " " . $program_version . ", " . $program_copyright . "\n";
