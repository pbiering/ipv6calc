...
static const db_file_desc2 libipv6calc_db_wrapper_GeoIP2_db_file_desc[] = {
	...
	{ GeoIP2_DB_COUNTRY_LITE
		...
		, IPV6CALC_DB_GEOIP2_INTERNAL_LITE
	},
...
static int geoip2_db_geonameid_v4 = 0;
static int geoip2_db_geonameid_v6 = 0;

#define GeoIP2_LITE	0
#define GeoIP2_COMM	1
#define	GeoIP2_MAX	2

static s_libipv6calc_db_wrapper_db_info geoip2_db_country_v4_best[GeoIP2_MAX];
static s_libipv6calc_db_wrapper_db_info geoip2_db_country_v6_best[GeoIP2_MAX];
static s_libipv6calc_db_wrapper_db_info geoip2_db_region_city_v4_best[GeoIP2_MAX];
static s_libipv6calc_db_wrapper_db_info geoip2_db_region_city_v6_best[GeoIP2_MAX];
static s_libipv6calc_db_wrapper_db_info geoip2_db_asn_v4_best[GeoIP2_MAX];
static s_libipv6calc_db_wrapper_db_info geoip2_db_asn_v6_best[GeoIP2_MAX];
static s_libipv6calc_db_wrapper_db_info geoip2_db_geonameid_v4_best[GeoIP2_MAX];
static s_libipv6calc_db_wrapper_db_info geoip2_db_geonameid_v6_best[GeoIP2_MAX];
...
int libipv6calc_db_wrapper_GeoIP2_wrapper_init(void) {
	...
	for (i = 0; i < MAXENTRIES_ARRAY(libipv6calc_db_wrapper_GeoIP2_db_file_desc); i++) {
		...
		if ((libipv6calc_db_wrapper_GeoIP2_db_file_desc[i].internal & IPV6CALC_DB_GEOIP2_INTERNAL_LITE) != 0) {
			product = GeoIP2_LITE;
		} else {
			product = GeoIP2_COMM;
		};
		...
		DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_GeoIP2, "GeoIP2 type=%d dbym=%d Year/Month=%d unixtime=%llu", dbtype, dbym, UNPACK_YM(dbym), (long long unsigned int) mmdb_cache[dbtype].metadata.build_epoch);
...
#define GeoIP2_DB_SELECT_BETTER(best) \
		...
		if ((libipv6calc_db_wrapper_GeoIP2_db_file_desc[i].features & IPV6CALC_DB_IPV4_TO_GEONAMEID) != 0) {
			GeoIP2_DB_SELECT_BETTER(geoip2_db_geonameid_v4_best[product])
		};

		if ((libipv6calc_db_wrapper_GeoIP2_db_file_desc[i].features & IPV6CALC_DB_IPV6_TO_GEONAMEID) != 0) {
			GeoIP2_DB_SELECT_BETTER(geoip2_db_geonameid_v6_best[product])
		};
...
#define SELECT_LITE_INSTEAD_OF_COMM(free, comm, final) \
	if ((free.num > 0) && (comm.num > 0)) { \
		...
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_country_v4_best[GeoIP2_LITE], geoip2_db_country_v4_best[GeoIP2_COMM], geoip2_db_country_v4)
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_country_v6_best[GeoIP2_LITE], geoip2_db_country_v6_best[GeoIP2_COMM], geoip2_db_country_v6)
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_region_city_v4_best[GeoIP2_LITE], geoip2_db_region_city_v4_best[GeoIP2_COMM], geoip2_db_region_city_v4)
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_region_city_v6_best[GeoIP2_LITE], geoip2_db_region_city_v6_best[GeoIP2_COMM], geoip2_db_region_city_v6)
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_asn_v4_best[GeoIP2_LITE], geoip2_db_asn_v4_best[GeoIP2_COMM], geoip2_db_asn_v4)
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_asn_v6_best[GeoIP2_LITE], geoip2_db_asn_v6_best[GeoIP2_COMM], geoip2_db_asn_v6)
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_geonameid_v4_best[GeoIP2_LITE], geoip2_db_geonameid_v4_best[GeoIP2_COMM], geoip2_db_geonameid_v4)
		SELECT_LITE_INSTEAD_OF_COMM(geoip2_db_geonameid_v6_best[GeoIP2_LITE], geoip2_db_geonameid_v6_best[GeoIP2_COMM], geoip2_db_geonameid_v6)
	};
...
#define FILL_EMPTY(product, final) \
	...
	FILL_EMPTY(geoip2_db_geonameid_v4_best[GeoIP2_COMM], geoip2_db_geonameid_v4)
	FILL_EMPTY(geoip2_db_geonameid_v6_best[GeoIP2_COMM], geoip2_db_geonameid_v6)

	// fill empty ones with free
	FILL_EMPTY(geoip2_db_country_v4_best[GeoIP2_LITE], geoip2_db_country_v4)
	FILL_EMPTY(geoip2_db_country_v6_best[GeoIP2_LITE], geoip2_db_country_v6)
	FILL_EMPTY(geoip2_db_region_city_v4_best[GeoIP2_LITE], geoip2_db_region_city_v4)
	FILL_EMPTY(geoip2_db_region_city_v6_best[GeoIP2_LITE], geoip2_db_region_city_v6)
	FILL_EMPTY(geoip2_db_asn_v4_best[GeoIP2_LITE], geoip2_db_asn_v4)
	FILL_EMPTY(geoip2_db_asn_v6_best[GeoIP2_LITE], geoip2_db_asn_v6)
	FILL_EMPTY(geoip2_db_geonameid_v4_best[GeoIP2_LITE], geoip2_db_geonameid_v4)
	FILL_EMPTY(geoip2_db_geonameid_v6_best[GeoIP2_LITE], geoip2_db_geonameid_v6)
	...
	for (i = 0; i < MAXENTRIES_ARRAY(libipv6calc_db_wrapper_GeoIP2_db_file_desc); i++) {
		if (mmdb_cache[libipv6calc_db_wrapper_GeoIP2_db_file_desc[i].number].file_size > 0) {
			if (
				(libipv6calc_db_wrapper_GeoIP2_db_file_desc[i].number == geoip2_db_country_v4_best[GeoIP2_LITE].num)
...
void libipv6calc_db_wrapper_GeoIP2_wrapper_info(char* string, const size_t size) {
	...
	snprintf(string, size, "GeoIP(MMDB) database support: Country4=%d Country6=%d City4=%d City6=%d ASN4=%d ASN6=%d GeonameID4=%d GeonameID6=%d"
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV4_TO_CC) ? 1 : 0
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV6_TO_CC) ? 1 : 0
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV4_TO_CITY) ? 1 : 0
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV6_TO_CITY) ? 1 : 0
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV4_TO_AS) ? 1 : 0
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV6_TO_AS) ? 1 : 0
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV4_TO_GEONAMEID) ? 1 : 0
		, (wrapper_features_by_source[IPV6CALC_DB_SOURCE_GEOIP2] & IPV6CALC_DB_IPV6_TO_GEONAMEID) ? 1 : 0
	);
...
void libipv6calc_db_wrapper_GeoIP2_wrapper_print_db_info(const int level_verbose, const char *prefix_string) {
	...
	if (count == 0) {
		...
		if (level_verbose >= LEVEL_VERBOSE) {
			db_info_all.country4.num    = geoip2_db_country_v4_best[GeoIP2_LITE].num;
			db_info_all.country4.dbtype = geoip2_db_country_v4_best[GeoIP2_LITE].dbtype;
			db_info_all.country4.dbym   = geoip2_db_country_v4_best[GeoIP2_LITE].dbym;
			db_info_all.country6.num    = geoip2_db_country_v6_best[GeoIP2_LITE].num;
			db_info_all.country6.dbtype = geoip2_db_country_v6_best[GeoIP2_LITE].dbtype;
			db_info_all.country6.dbym   = geoip2_db_country_v6_best[GeoIP2_LITE].dbym;
			db_info_all.city4.num    = geoip2_db_region_city_v4_best[GeoIP2_LITE].num;
			db_info_all.city4.dbtype = geoip2_db_region_city_v4_best[GeoIP2_LITE].dbtype;
			db_info_all.city4.dbym   = geoip2_db_region_city_v4_best[GeoIP2_LITE].dbym;
			db_info_all.city6.num    = geoip2_db_region_city_v6_best[GeoIP2_LITE].num;
			db_info_all.city6.dbtype = geoip2_db_region_city_v6_best[GeoIP2_LITE].dbtype;
			db_info_all.city6.dbym   = geoip2_db_region_city_v6_best[GeoIP2_LITE].dbym;
			db_info_all.asn4.num    = geoip2_db_asn_v4_best[GeoIP2_LITE].num;
			db_info_all.asn4.dbtype = geoip2_db_asn_v4_best[GeoIP2_LITE].dbtype;
			db_info_all.asn4.dbym   = geoip2_db_asn_v4_best[GeoIP2_LITE].dbym;
			db_info_all.asn6.num    = geoip2_db_asn_v6_best[GeoIP2_LITE].num;
			db_info_all.asn6.dbtype = geoip2_db_asn_v6_best[GeoIP2_LITE].dbtype;
			db_info_all.asn6.dbym   = geoip2_db_asn_v6_best[GeoIP2_LITE].dbym;
			db_info_all.geonameid4.num    = geoip2_db_geonameid_v4_best[GeoIP2_LITE].num;
			db_info_all.geonameid4.dbtype = geoip2_db_geonameid_v4_best[GeoIP2_LITE].dbtype;
			db_info_all.geonameid4.dbym   = geoip2_db_geonameid_v4_best[GeoIP2_LITE].dbym;
			db_info_all.geonameid6.num    = geoip2_db_geonameid_v6_best[GeoIP2_LITE].num;
			db_info_all.geonameid6.dbtype = geoip2_db_geonameid_v6_best[GeoIP2_LITE].dbtype;
			db_info_all.geonameid6.dbym   = geoip2_db_geonameid_v6_best[GeoIP2_LITE].dbym;
			libipv6calc_db_wrapper_print_db_info_line(level_verbose, prefix_string, "GeoIP(MMDB)", "detected best databases LITE", 1, db_info_all, 0);

			db_info_all.country4.num    = geoip2_db_country_v4_best[GeoIP2_COMM].num;
			db_info_all.country4.dbtype = geoip2_db_country_v4_best[GeoIP2_COMM].dbtype;
			db_info_all.country4.dbym   = geoip2_db_country_v4_best[GeoIP2_COMM].dbym;
			db_info_all.country6.num    = geoip2_db_country_v6_best[GeoIP2_COMM].num;
			db_info_all.country6.dbtype = geoip2_db_country_v6_best[GeoIP2_COMM].dbtype;
			db_info_all.country6.dbym   = geoip2_db_country_v6_best[GeoIP2_COMM].dbym;
			db_info_all.city4.num    = geoip2_db_region_city_v4_best[GeoIP2_COMM].num;
			db_info_all.city4.dbtype = geoip2_db_region_city_v4_best[GeoIP2_COMM].dbtype;
			db_info_all.city4.dbym   = geoip2_db_region_city_v4_best[GeoIP2_COMM].dbym;
			db_info_all.city6.num    = geoip2_db_region_city_v6_best[GeoIP2_COMM].num;
			db_info_all.city6.dbtype = geoip2_db_region_city_v6_best[GeoIP2_COMM].dbtype;
			db_info_all.city6.dbym   = geoip2_db_region_city_v6_best[GeoIP2_COMM].dbym;
			db_info_all.asn4.num    = geoip2_db_asn_v4_best[GeoIP2_COMM].num;
			db_info_all.asn4.dbtype = geoip2_db_asn_v4_best[GeoIP2_COMM].dbtype;
			db_info_all.asn4.dbym   = geoip2_db_asn_v4_best[GeoIP2_COMM].dbym;
			db_info_all.asn6.num    = geoip2_db_asn_v6_best[GeoIP2_COMM].num;
			db_info_all.asn6.dbtype = geoip2_db_asn_v6_best[GeoIP2_COMM].dbtype;
			db_info_all.asn6.dbym   = geoip2_db_asn_v6_best[GeoIP2_COMM].dbym;
			db_info_all.geonameid4.num    = geoip2_db_geonameid_v4_best[GeoIP2_COMM].num;
			db_info_all.geonameid4.dbtype = geoip2_db_geonameid_v4_best[GeoIP2_COMM].dbtype;
			db_info_all.geonameid4.dbym   = geoip2_db_geonameid_v4_best[GeoIP2_COMM].dbym;
			db_info_all.geonameid6.num    = geoip2_db_geonameid_v6_best[GeoIP2_COMM].num;
			db_info_all.geonameid6.dbtype = geoip2_db_geonameid_v6_best[GeoIP2_COMM].dbtype;
			db_info_all.geonameid6.dbym   = geoip2_db_geonameid_v6_best[GeoIP2_COMM].dbym;
			libipv6calc_db_wrapper_print_db_info_line(level_verbose, prefix_string, "GeoIP(MMDB)", "detected best databases COMM", 1, db_info_all, 0);

			db_info_all.country4.num    = geoip2_db_country_v4;
			db_info_all.country6.num    = geoip2_db_country_v6;
			db_info_all.city4.num    = geoip2_db_region_city_v4;
			db_info_all.city6.num    = geoip2_db_region_city_v6;
			db_info_all.asn4.num    = geoip2_db_asn_v4;
			db_info_all.asn6.num    = geoip2_db_asn_v6;
			db_info_all.geonameid4.num    = geoip2_db_geonameid_v4;
			db_info_all.geonameid6.num    = geoip2_db_geonameid_v6;
			libipv6calc_db_wrapper_print_db_info_line(level_verbose, prefix_string, "GeoIP(MMDB)", "selected best databases normal", 1, db_info_all, 1);

			if (geoip2_db_comm_to_free_switch_min_delta_months > 0) {
				fprintf(stderr, "%sGeoIP(MMDB): selected best databases method : COMM older than %d months are deselected in case of LITE is available\n"
					, prefix
			...
			if (geoip2_db_better_max_delta_months > 0) {
				fprintf(stderr, "%sGeoIP(MMDB): selected best databases method : COMM/LITE with more features are only selected in case not older than %d months of already found COMM/LITE\n"
					, prefix
 ...
 */
uint32_t libipv6calc_db_wrapper_GeoIP2_wrapper_asn_by_addr(const ipv6calc_ipaddr *ipaddrp, char *as_orgname, const size_t as_orgname_length) {
	...
	DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_GeoIP2, "result AS_NUM=%u", as_num);
