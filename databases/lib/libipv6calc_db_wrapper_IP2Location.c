...
#define IP2LOCATION_DYN_LOAD(M_dl_symbol, M_dl_status, M_dl_obj) \
	if (dl_IP2Location_handle == NULL) { \
		fprintf(stderr, "dl_IP2Location handle not defined\n"); \
	} else if (M_dl_status == IPV6CALC_DL_STATUS_UNKNOWN) { \
		DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_IP2Location, "Call dlsym: %s", M_dl_symbol); \
		dlerror(); \
		*(void **) (&M_dl_obj) = dlsym(dl_IP2Location_handle, M_dl_symbol); \
		if ((error = dlerror()) != NULL)  { \
			M_dl_status = IPV6CALC_DL_STATUS_ERROR; \
			fprintf(stderr, "%s\n", error); \
		} else { \
			M_dl_status = IPV6CALC_DL_STATUS_OK; \
			DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_IP2Location, "Called dlsym successful: %s", M_dl_symbol); \
		}; \
	} else if (M_dl_status == IPV6CALC_DL_STATUS_ERROR) { \
		DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_IP2Location, "Previous call of dlsym already failed: %s", M_dl_symbol); \
	} else { \
		DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_IP2Location, "Previous call of dlsym already successful: %s", M_dl_symbol); \
	};
...
/* database files */
static const db_file_desc2 libipv6calc_db_wrapper_IP2Location_db_file_desc[] = {
	...
	{ IP2LOCATION_IPV4_SAMPLE_DB26,
		"IP-COUNTRY-REGION-CITY-LATITUDE-LONGITUDE-ZIPCODE-TIMEZONE-ISP-DOMAIN-NETSPEED-AREACODE-WEATHER-MOBILE-ELEVATION-USAGETYPE-ADDRESSTYPE-CATEGORY-DISTRICT-ASN-SAMPLE.BIN", IP2LOCATION_DB26,
		IPV6CALC_DB_SC_IP2LOCATION_IPV4_ASN , IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE | IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },
	{ IP2LOCATION_IPV4_SAMPLE_ASN,
		"IP-ASN-SAMPLE.BIN", IP2LOCATION_ASN,
		IPV6CALC_DB_IPV4_TO_AS, IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE | IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },

	// SAMPLES IPv6 (having also IPv4 included)
	{ IP2LOCATION_IPV6_SAMPLE_DB1,
		"IPV6-COUNTRY.SAMPLE.BIN", IP2LOCATION_DB1,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_COUNTRY, IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE },
	...
	{ IP2LOCATION_IPV6_SAMPLE_DB3,
		...
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE },
	...
	{ IP2LOCATION_IPV6_SAMPLE_DB21,
		...
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE | IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_6 },
	...
	{ IP2LOCATION_IPV6_SAMPLE_DB25,
		...
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE | IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_4 },
	{ IP2LOCATION_IPV6_SAMPLE_DB26,
		"IPV6-COUNTRY-REGION-CITY-LATITUDE-LONGITUDE-ZIPCODE-TIMEZONE-ISP-DOMAIN-NETSPEED-AREACODE-WEATHER-MOBILE-ELEVATION-USAGETYPE-ADDRESSTYPE-CATEGORY-DISTRICT-ASN.SAMPLE.BIN", IP2LOCATION_DB26,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_ASN , IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE | IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },
	{ IP2LOCATION_IPV6_SAMPLE_ASN,
		"IPV6-ASN-SAMPLE.BIN", IP2LOCATION_ASN,
		IPV6CALC_DB_IPV6_TO_AS | IPV6CALC_DB_IPV4_TO_AS, IPV6CALC_DB_IP2LOCATION_INTERNAL_SAMPLE | IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },
	...
	{ IP2LOCATION_DB_IP_COUNTRY_REG_CIT_LL_ZIP_TZ_LITE, "IP2LOCATION-LITE-DB11.BIN", IP2LOCATION_DB11,
		IPV6CALC_DB_SC_IP2LOCATION_IPV4_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_LITE },
	{ IP2LOCATION_DB_IP_ASN_LITE, "IP2LOCATION-LITE-ASN.BIN", IP2LOCATION_ASN,
		IPV6CALC_DB_IPV4_TO_AS, IPV6CALC_DB_IP2LOCATION_INTERNAL_LITE },

	// LITE IPv6 (having also IPv4 included)
	{ IP2LOCATION_DB_IPV6_COUNTRY_LITE, "IP2LOCATION-LITE-DB1.IPV6.BIN", IP2LOCATION_DB1,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_COUNTRY, IPV6CALC_DB_IP2LOCATION_INTERNAL_LITE },
	{ IP2LOCATION_DB_IPV6_COUNTRY_REG_CIT_LITE, "IP2LOCATION-LITE-DB3.IPV6.BIN", IP2LOCATION_DB2,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_LITE },
	...
	{ IP2LOCATION_DB_IPV6_COUNTRY_REG_CIT_LL_ZIP_TZ_LITE, "IP2LOCATION-LITE-DB11.IPV6.BIN", IP2LOCATION_DB11,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_LITE },
	{ IP2LOCATION_DB_IPV6_ASN_LITE, "IP2LOCATION-LITE-ASN.IPV6.BIN", IP2LOCATION_ASN,
		IPV6CALC_DB_IPV6_TO_AS | IPV6CALC_DB_IPV4_TO_AS, IPV6CALC_DB_IP2LOCATION_INTERNAL_LITE },
	...
	{ IP2LOCATION_IPV4_DB26,
		"IP-COUNTRY-REGION-CITY-LATITUDE-LONGITUDE-ZIPCODE-TIMEZONE-ISP-DOMAIN-NETSPEED-AREACODE-WEATHER-MOBILE-ELEVATION-USAGETYPE-ADDRESSTYPE-CATEGORY-DISTRICT-ASN.BIN", IP2LOCATION_DB26,
		IPV6CALC_DB_SC_IP2LOCATION_IPV4_ASN , IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },
	{ IP2LOCATION_IPV4_ASN,
		"IP-ASN.BIN", IP2LOCATION_ASN,
		IPV6CALC_DB_IPV4_TO_AS, IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },

	// Commercial IPv6 (having also IPv4 included)
	{ IP2LOCATION_IPV6_DB1,
		"IPV6-COUNTRY.BIN", IP2LOCATION_DB1,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_COUNTRY, 0 },
	{ IP2LOCATION_IPV6_DB2,
		"IPV6-COUNTRY-ISP.BIN", IP2LOCATION_DB2,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_COUNTRY, 0 },
	{ IP2LOCATION_IPV6_DB3,
		"IPV6-COUNTRY-REGION-CITY.BIN", IP2LOCATION_DB3,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, 0 },
	...
	{ IP2LOCATION_IPV6_DB21,
		...
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_6 },
	...
	{ IP2LOCATION_IPV6_DB25,
		...
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_CITY, IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_4 },
	{ IP2LOCATION_IPV6_DB26,
		"IPV6-COUNTRY-REGION-CITY-LATITUDE-LONGITUDE-ZIPCODE-TIMEZONE-ISP-DOMAIN-NETSPEED-AREACODE-WEATHER-MOBILE-ELEVATION-USAGETYPE-ADDRESSTYPE-CATEGORY-DISTRICT-ASN.BIN", IP2LOCATION_DB26,
		IPV6CALC_DB_SC_IP2LOCATION_IPVx_ASN, IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },
	{ IP2LOCATION_IPV6_ASN,
		"IPV6-ASN.BIN", IP2LOCATION_ASN,
		IPV6CALC_DB_IPV6_TO_AS | IPV6CALC_DB_IPV4_TO_AS, IPV6CALC_DB_IP2LOCATION_INTERNAL_LIB_VERSION_8_6 },
};


/* text representations */
static const s_type libipv6calc_db_wrapper_IP2Location_IPv6_support[] = {
...
static int ip2location_db_asn_sample_v4_lite_autoswitch = 0;
static int ip2location_db_asn_sample_v6_lite_autoswitch = 0;
...
int libipv6calc_db_wrapper_IP2Location_wrapper_init(void) {
	...
	*(void **) (&IP2Location_get_usagetype) = dlsym(dl_IP2Location_handle, "IP2Location_get_usagetype");
	...
	IP2LOCATION_DYN_LOAD("IP2Location_api_version_num", dl_status_IP2Location_api_version_num, dl_IP2Location_api_version_num.obj)

	if (dl_status_IP2Location_api_version_num == IPV6CALC_DL_STATUS_ERROR) {
		ERRORPRINT_NA("IP2Location(BIN) library is no longer supported (missing function api_version_num)");
		return(1);
	};
...
#define IP2L_DB_SELECT_BETTER(best) \
		...
		if ((libipv6calc_db_wrapper_IP2Location_db_file_desc[i].features & (IPV6CALC_DB_IPV6_TO_AS)) != 0) {
...
#define SELECT_LITE_SAMPLE_AUTOSWITCH(sample, lite, autoswitch) \
		...
		SELECT_LITE_SAMPLE_AUTOSWITCH(ip2location_db_asn_v4_best[IP2L_SAMPLE], ip2location_db_asn_v4_best[IP2L_LITE], ip2location_db_asn_sample_v4_lite_autoswitch)
		SELECT_LITE_SAMPLE_AUTOSWITCH(ip2location_db_asn_v6_best[IP2L_SAMPLE], ip2location_db_asn_v6_best[IP2L_LITE], ip2location_db_asn_sample_v6_lite_autoswitch)
	};
...
#define SELECT_LITE_INSTEAD_OF_COMM(lite, comm, final) \
	if ((lite.num > 0) && (comm.num > 0)) { \
		...
		SELECT_LITE_INSTEAD_OF_COMM(ip2location_db_asn_v4_best[IP2L_LITE], ip2location_db_asn_v4_best[IP2L_COMM], ip2location_db_asn_v4)
		SELECT_LITE_INSTEAD_OF_COMM(ip2location_db_asn_v6_best[IP2L_LITE], ip2location_db_asn_v6_best[IP2L_COMM], ip2location_db_asn_v6)
	};
...
#define FILL_EMPTY(product, final) \
	...
	FILL_EMPTY(ip2location_db_asn_v4_best[IP2L_COMM], ip2location_db_asn_v4)
	FILL_EMPTY(ip2location_db_asn_v6_best[IP2L_COMM], ip2location_db_asn_v6)
	...
	FILL_EMPTY(ip2location_db_asn_v4_best[IP2L_LITE], ip2location_db_asn_v4)
	FILL_EMPTY(ip2location_db_asn_v6_best[IP2L_LITE], ip2location_db_asn_v6)
	...
	FILL_EMPTY(ip2location_db_asn_v4_best[IP2L_SAMPLE], ip2location_db_asn_v4)
	FILL_EMPTY(ip2location_db_asn_v6_best[IP2L_SAMPLE], ip2location_db_asn_v6)
...
#ifdef SUPPORT_IP2LOCATION_DYN
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_close", dl_status_IP2Location_close, dl_IP2Location_close.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_close == IPV6CALC_DL_STATUS_ERROR)) {
...
#ifdef SUPPORT_IP2LOCATION
	snprintf(string, size, "IP2Location(BIN) database support: Country4=%d Country6=%d City4=%d City6=%d ASN4=%d ASN6=%d GeonameID4=%d GeonameID6=%d"
		...
		, 0  // GeonameID IPv4 not supported so far
		, 0  // GeonameID IPv6 not supported so far
	);
#else
...
char *libipv6calc_db_wrapper_IP2Location_lib_version(void) {
...
#ifdef SUPPORT_IP2LOCATION_DYN
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_api_version_string", dl_status_IP2Location_api_version_string, dl_IP2Location_api_version_string.obj)
	...
	IP2LOCATION_DYN_LOAD("IP2Location_lib_version_string", dl_status_IP2Location_lib_version_string, dl_IP2Location_lib_version_string.obj)
...
IP2Location *libipv6calc_db_wrapper_IP2Location_open(char *db) {
	...
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_open", dl_status_IP2Location_open, dl_IP2Location_open.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_open == IPV6CALC_DL_STATUS_ERROR)) {
		goto END_libipv6calc_db_wrapper;
	};
...
#ifdef SUPPORT_IP2LOCATION_DYN
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_free_record", dl_status_IP2Location_free_record, dl_IP2Location_free_record.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_free_record == IPV6CALC_DL_STATUS_ERROR)) {
		goto END_libipv6calc_db_wrapper;
	};
...
IP2LocationRecord *libipv6calc_db_wrapper_IP2Location_get_country_short(IP2Location *loc, char *ip) {
	...
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_get_country_short", dl_status_IP2Location_get_country_short, dl_IP2Location_get_country_short.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_get_country_short == IPV6CALC_DL_STATUS_ERROR)) {
		goto END_libipv6calc_db_wrapper;
	};
...
IP2LocationRecord *libipv6calc_db_wrapper_IP2Location_get_country_long(IP2Location *loc, char *ip) {
	...
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_get_country_long", dl_status_IP2Location_get_country_long, dl_IP2Location_get_country_long.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_get_country_long == IPV6CALC_DL_STATUS_ERROR)) {
		goto END_libipv6calc_db_wrapper;
	};
 ...
 */
IP2LocationRecord *libipv6calc_db_wrapper_IP2Location_get_as_number(IP2Location *loc, char *ip) {
	DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_IP2Location, "Called: %s ip=%s", wrapper_ip2location_info, ip);

#ifdef SUPPORT_IP2LOCATION_DYN
	IP2LocationRecord *result_IP2Location_get_asn = NULL;

	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_get_asn", dl_status_IP2Location_get_asn, dl_IP2Location_get_asn.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_get_asn == IPV6CALC_DL_STATUS_ERROR)) {
		goto END_libipv6calc_db_wrapper;
	};

	dlerror();    /* Clear any existing error */

	result_IP2Location_get_asn = (*dl_IP2Location_get_asn.func)(loc, ip);
...
IP2LocationRecord *libipv6calc_db_wrapper_IP2Location_get_as_name(IP2Location *loc, char *ip) {
	...
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_get_as", dl_status_IP2Location_get_as, dl_IP2Location_get_as.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_get_as == IPV6CALC_DL_STATUS_ERROR)) {
		goto END_libipv6calc_db_wrapper;
	};
...
#ifdef SUPPORT_IP2LOCATION_DYN
	char *error;
	IP2LOCATION_DYN_LOAD("IP2Location_get_all", dl_status_IP2Location_get_all, dl_IP2Location_get_all.obj)
	if ((dl_IP2Location_handle == NULL) || (dl_status_IP2Location_get_all == IPV6CALC_DL_STATUS_ERROR)) {
		goto END_libipv6calc_db_wrapper;
	};
...
uint32_t libipv6calc_db_wrapper_IP2Location_wrapper_asn_by_addr(const ipv6calc_ipaddr *ipaddrp, char *as_orgname, const size_t as_orgname_length) {
	...
	if (ipaddrp->proto == IPV6CALC_PROTO_IPV4) {
		IP2Location_type = ip2location_db_asn_v4;

		if ((wrapper_features_by_source[IPV6CALC_DB_SOURCE_IP2LOCATION] & IPV6CALC_DB_IPV4_TO_AS) == 0) {
			DEBUGPRINT_NA(DEBUG_libipv6calc_db_wrapper_IP2Location, "No IP2Location database supporting IPv4 ASN");
			goto END_libipv6calc_db_wrapper;
		};
	} else if (ipaddrp->proto == IPV6CALC_PROTO_IPV6) {
		IP2Location_type = ip2location_db_asn_v6;

		if ((wrapper_features_by_source[IPV6CALC_DB_SOURCE_IP2LOCATION] & IPV6CALC_DB_IPV6_TO_AS) == 0) {
			DEBUGPRINT_NA(DEBUG_libipv6calc_db_wrapper_IP2Location, "No IP2Location database supporting IPv6 ASN");
			goto END_libipv6calc_db_wrapper;
		};
	} else {
		DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_IP2Location, "Unsupported proto: %d", ipaddrp->proto);
		goto END_libipv6calc_db_wrapper;
	};

	if (IP2Location_type == 0) {
		DEBUGPRINT_WA(DEBUG_libipv6calc_db_wrapper_IP2Location, "No IP2Location database selected for proto: %d", ipaddrp->proto);
		goto END_libipv6calc_db_wrapper;
	};
...
#else // SUPPORT_IP2LOCATION_DYN
	result = IP2Location_api_version_num() / 100;
#endif // SUPPORT_IP2LOCATION_DYN
