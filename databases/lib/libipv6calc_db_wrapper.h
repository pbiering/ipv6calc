...
#define IPV6CALC_DB_FEATURE_NUM_IPV4_DUMP		19
#define IPV6CALC_DB_FEATURE_NUM_IPV6_DUMP		20
#define IPV6CALC_DB_FEATURE_NUM_MAX			IPV6CALC_DB_FEATURE_NUM_IPV6_DUMP
...
#define IPV6CALC_DB_IPV4_DUMP			(1 << IPV6CALC_DB_FEATURE_NUM_IPV4_DUMP)
#define IPV6CALC_DB_IPV6_DUMP			(1 << IPV6CALC_DB_FEATURE_NUM_IPV6_DUMP)
...
static const s_formatoption ipv6calc_db_features[] = {
	...
	{ IPV6CALC_DB_IPV4_DUMP		, "DB_IPV4_DUMP"	, "IPv4 Database Dump" },
	{ IPV6CALC_DB_IPV6_DUMP		, "DB_IPV6_DUMP"	, "IPv6 Database Dump" },
};
