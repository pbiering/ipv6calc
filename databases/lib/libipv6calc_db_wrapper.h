 ...
 * Version    : $Id: libipv6calc_db_wrapper.h,v 1.14 2013/09/20 06:17:52 ds6peter Exp $
...
extern int  libipv6calc_db_wrapper_options(const int opt, const char *optarg, const int quiet, const struct option longopts[]);
