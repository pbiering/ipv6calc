 ...
 * Version    : $Id: libipv6calc_db_wrapper_GeoIP.c,v 1.7 2013/07/07 20:21:14 ds6peter Exp $
 ...
 * out: (void)
 */
void libipv6calc_db_wrapper_GeoIP_wrapper_print_db_info(const int level_verbose) {
	GeoIP *gi;
	int i;
