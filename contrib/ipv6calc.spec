...
# $Id: ipv6calc.spec,v 1.278 2015/06/01 06:21:14 ds6peter Exp $
...
%{?enable_shared:Provides: ipv6calc-lib = %%{version}-%%{release}}
...
%{?enable_shared:Requires: ipv6calc-lib = %%{version}-%%{release}}
