...
# $Id: ipv6calc.spec,v 1.279 2015/06/01 06:38:15 ds6peter Exp $
...
%{?enable_shared:Provides: ipv6calc-libs = %{version}-%{release}}
...
%{?enable_shared:Requires: ipv6calc-libs = %{version}-%{release}}
...
%files
%doc ChangeLog README CREDITS TODO USAGE doc/ipv6calc.{lyx,sgml,html,xml}
