...
# Location of binary
my $bin_ipv6calc = "/home/peter/src/ipv6calc/ipv6calc";
...
&print_tagoutput ( "        <td colspan=\"3\">" );
if ($outputformat eq "html" || $outputformat eq "htmlfull") {
	print "<font size=-2>&copy; 2002 by Peter Bieringer, powered by <a href=\"http://www.bieringer.de/linux/IPv6/ipv6calc/\">ipv6calc</a></font>";
} else {
	print "(C) 2002 by Peter Bieringer, powered by ipv6calc (http://www.bieringer.de/linux/IPv6/ipv6calc/)";
};
&print_tagoutput ( "</td>\n" );
&print_tagoutput ( "      </tr>\n" );
